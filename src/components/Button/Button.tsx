...
export function Button() {
  ...
  return (
    <div className="z-10 -mt-5 flex items-center justify-center transition-colors delay-75">
      {!isActive ? (
        // Botón inactivo
        <button
          className="transition-colors duration-200 ease-in hover:text-MentorRed flex items-center justify-center border rounded-3xl w-30 h-fit px-3 py-2 border-MentorRed bg-white text-xs font-bold"
        ...
        // Botón activo
        <div className=" font-semibold cursor-pointer flex items-center justify-center border rounded-3xl w-30 h-fit px-3 py-2 border-MentorRed bg-MentorRed text-white text-xs">
          <button
