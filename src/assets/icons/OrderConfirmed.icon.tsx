export type OrderConfirmedIconProps= {
    fill?: string;
    className?: string;
};
export function OrderConfirmedIcon({className, fill="currentColor"}:OrderConfirmedIconProps){
    return(
        <svg width="48" height="48" viewBox="0 0 48 48" fill={fill} className={className} xmlns="http://www.w3.org/2000/svg">
